...
import { LayoutGrid, Filter, Plus, Building2, Bell, BellDot, AlertTriangle, ShieldCheck, Wallet, Terminal, User, Printer, Activity } from 'lucide-react';
                        ...
                        activeTab === 'users' ? 'Gestión de Personal' :
                          activeTab === 'sedes' ? 'Administración de Sedes' :
                            activeTab === 'hotels' ? 'Gestión Hotelera' :
                              activeTab === 'contabilidad' ? 'Contabilidad General' : 'Seguridad y Auditoría'}
                </h1>
              </div>
          ...
          <div className="bg-white rounded-[2rem] w-full max-w-sm overflow-hidden shadow-2xl animate-in zoom-in slide-in-from-bottom-4 duration-300 text-center">
            ...
            <div className="p-8 space-y-6">
              ...
              <div className="flex flex-col gap-3">
                <button
                  onClick={() => { setShowShiftWarning(false); setActiveTab('turnos'); }}
